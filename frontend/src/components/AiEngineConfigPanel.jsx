    ...
    <div className="ai-engine-config">
      <div className="ai-engine-config__head">
        <p className="ai-engine-config__intro">
          Configure the AI provider, analysis settings, and per-document evaluation rules.
        </p>
      ...
      <div className="ai-config-grid">
        ...
        <section className="card ai-config-card ai-config-card--full">
          ...
          <p className="ai-config-card__desc">
            Configure how the AI evaluates each capstone document. Intake source is set automatically from Artifact Upload.
          </p>
                  ...
                  <tr key={doc.id}>
                    ...
                    <td>
                      <button
                        ...
                        aria-label={`Toggle AI analysis for ${doc.name}`}
                    ...
                    <td>
                      <input
                        ...
                        disabled={!doc.enabled}
                        placeholder="Custom AI evaluation rules..."
