          ...
          <div className="hub-banner__left">
            ...
            <div>
              ...
              <p className="hub-banner__subtitle banner-accent-line--with-text">
                ...
                Monitor extraction from MetaDoc, IEEE Docs Evaluator, and SyncTrace source-code analysis.
              </p>
            </div>
          </div>
        </header>
=======
        ...
        />
>>>>>>> c8e53a5 (feature(ui): implement standardized PageBanner component across all modules)
